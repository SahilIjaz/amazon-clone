...
export default function Gallery({ images, title }: { images: string[]; title: string }) {
  ...
  return (
    <div className="flex gap-3">
      ...
      <div className="relative h-[560px] flex-1 bg-white"><Image src={images[i]!} alt={title} fill sizes="(min-width: 1024px) 40vw, 100vw" priority className="object-contain" /></div>
    </div>
  );
}
