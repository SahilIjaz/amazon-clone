          ...
          <section className="bg-white p-5">
            {active.length === 0 ? (
              <div className="flex items-center gap-6">
                <svg width="260" height="190" viewBox="0 0 260 190" aria-hidden="true"><rect width="260" height="190" rx="14" fill="#f0f7f7" /><path d="M40 150c0-30 12-52 40-52s40 22 40 52z" fill="#3d9a9a" /><rect x="52" y="86" width="56" height="14" rx="7" fill="#2d7f7f" /><path d="M120 120h14a10 10 0 0 1 0 20h-14" fill="none" stroke="#3d9a9a" strokeWidth="7" /><rect x="76" y="70" width="8" height="18" rx="4" fill="#2d7f7f" /><rect x="150" y="70" width="70" height="80" rx="8" fill="#0f1111" /><rect x="156" y="78" width="58" height="64" rx="3" fill="#8ed6d6" /><circle cx="212" cy="46" r="18" fill="#fff" stroke="#0f1111" strokeWidth="4" /><path d="M212 36v11l7 4" stroke="#0f1111" strokeWidth="3" strokeLinecap="round" fill="none" /><rect x="150" y="152" width="40" height="18" rx="4" fill="#febd69" /><path d="M50 40c6-10 18-12 26-6M40 54c8-14 26-16 38-8" stroke="#3d9a9a" strokeWidth="3" fill="none" strokeLinecap="round" /><circle cx="118" cy="40" r="4" fill="#0f1111" /><path d="M122 40v-16l10-3" stroke="#0f1111" strokeWidth="3" fill="none" strokeLinecap="round" /><circle cx="132" cy="19" r="4" fill="#0f1111" /></svg>
                <div>
